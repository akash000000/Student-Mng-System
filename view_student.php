                ...
                <table class="table table-bordered text-white table-responsive">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <a href="st_image/<?php echo $row['student_photo']; ?>">
                          <img src="st_image/<?php echo $row['student_photo']; ?>" width="50" height="50"></a>
                      </td>

                      <td>
                        <a style="color: white; text-decoration: none;"
                          href="edit_student_detail.php?edit_student=<?php echo $row['st_id'];  ?>">Edit</a> |
                        <a style="color: white; text-decoration: none;"
                          href="delete_student_detail.php?delete_student=<?php echo $row['st_id'];  ?>">Delete</a>
                      </td>
                    </tr>
                  </tbody>
                  <?php   } ?>
